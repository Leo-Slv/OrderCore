...
public sealed class PublishProductUseCaseTests
{
    ...
    public async Task ExecuteAsync_publishes_a_draft_product()
    {
        ...
        var useCase = new PublishProductUseCase(products, new FakeStockAvailabilityProvider(), new FakeStockAvailabilityProvider(), new FakeAuditLogService(), TimeProvider.System);
    ...
    {
        var useCase = new PublishProductUseCase(new FakeProductRepository(), new FakeStockAvailabilityProvider(), new FakeStockAvailabilityProvider(), new FakeAuditLogService(), TimeProvider.System);
